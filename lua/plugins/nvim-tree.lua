		...
		require("nvim-tree").setup({
			...
			on_attach = function(bufnr)
				...
				vim.keymap.set(
					...
					{ desc = "Open in horizontal split", buffer = bufnr }
				)
			...
			view = {
				width = { -- Adaptive sizing, makes the nvim tree just the width to fit everything THIS IS SO FUCKIN COOL WTFFFFF
					min = 30,
					max = -1,
					padding = 1,
				},
			...
			renderer = {
				...
				-- icons = {        -- You can customize it as you wish, this is default
				-- 	glyphs = {
				-- 		default = "󰈚",
				-- 		folder = {
				-- 			default = "",

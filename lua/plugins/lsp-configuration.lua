	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set(
				...
				{ desc = "Open float window with diagnostics" }
			) -- You can copy the error from this window
			...
			local diag_presets = {
				...
				[4] = {
					...
					label = "Showing: Errors + Warnings + Info + Hints",
				},
			}
			...
			vim.keymap.set("n", "<leader>l0", function()
				set_diagnostics_mode(0)
			end, { desc = "Diagnostics OFF" })
			vim.keymap.set("n", "<leader>l1", function()
				set_diagnostics_mode(1)
			end, { desc = "Showing: Errors only" })
			vim.keymap.set("n", "<leader>l2", function()
				set_diagnostics_mode(2)
			end, { desc = "Showing: Errors + Warnings" })
			vim.keymap.set("n", "<leader>l3", function()
				set_diagnostics_mode(3)
			end, { desc = "Showing: Errors + Warnings + Info" })
			vim.keymap.set("n", "<leader>l4", function()
				set_diagnostics_mode(4)
			end, { desc = "Showing: Errors + Warnings + Info + Hints" })

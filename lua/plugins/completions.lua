		...
		config = function()
			...
			cmp.setup({
				...
				mapping = cmp.mapping.preset.insert({
					...
					["<C-m>"] = cmp.mapping.confirm({ select = true }), -- Select the first one automatically
					["<CR>"] = cmp.mapping.confirm(), -- Select the one that u are really hovering over in the prompt
